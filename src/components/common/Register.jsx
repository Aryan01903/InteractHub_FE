  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md relative">
        ...
        <h2 className="text-[#3aabb7] text-4xl font-bold text-center mb-6">Register</h2>
        <form onSubmit={handleRegister}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Name Input */}
            <div className="col-span-1">
              <label className="block text-[#3aabb7] text-lg font-bold mb-1">Name</label>
              <input
                type="text"
            ...
            {/* Role Selection */}
            <div className="col-span-1">
              <label className="block text-[#3aabb7] text-lg font-bold mb-1">Role</label>
              <select
            ...
            {role === "admin" && (
              <div className="col-span-1">
                <label className="block text-[#3aabb7] text-lg font-bold mb-1">Tenant Name</label>
                <input
                  type="text"
            ...
            {role === "member" && (
              <div className="col-span-1">
                <label className="block text-[#3aabb7] text-lg font-bold mb-1">Tenant ID</label>
                <input
                  type="text"
            ...
            <div className="col-span-1">
              <label className="block text-[#3aabb7] text-lg font-bold mb-1">Confirm Password</label>
              <div className="relative mb-4">
                <input
                ...
                <span
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-xl cursor-pointer text-gray-500"
                  onClick={() => setConfirmTogglePassword(!confirmTogglePassword)}
                >
          ...
          <p className="text-xs mb-1">
            <span className="text-red-500">*</span> Use at least 8 characters, one uppercase, one lowercase, one number, and one special character($&@#_-+%^*!)
          </p>
